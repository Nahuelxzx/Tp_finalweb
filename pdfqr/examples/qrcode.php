...
<page backtop="10mm" >
	...
	<img src="enc-boarding.jpg" alt="encabezado" width="720" height="42"/>
	
	<table style="border: solid 0px black; width: 140mm;">
    <tr>
	...
	<td style="width: 40%; border: solid 0px black; text-align: left; background-color:#D1D1E0">ORIGEN:<?php echo"$origen <br>"; ?> DESTINO:<?php echo "$destino"; ?></td>
	<td style="width: 40%; border: solid 0px black; text-align: left; background-color:#D1D1E0">ORIGEN:<?php echo"$origen <br>"; ?> DESTINO:<?php echo "$destino"; ?></td>
	<td><qrcode value="<?php echo $msg; ?>" ec="L" style="width: 35mm;"></qrcode></td>
	</tr>
	<tr>
	...
	<tr>
	<td style="width: 40%; border: solid 0px black; text-align: left; ">ASIENTO:<?php echo "$asiento"; ?></td>
	<td style="width: 40%; border: solid 0px black; text-align: left; ">ASIENTO:<?php echo "$asiento"; ?></td>
	<td style="width: 40%; border: solid 0px black; text-align: left; ">ASIENTO:<?php echo "$asiento"; ?></td>
	</tr>
	<tr>
...
<img src="pie-boarding.jpg" alt="pie" width="720" height="42"/>	
	
	<h3 style="background-color:#D1D1E0">Imprima su boarding con su Qrcode o solo su QRcode </h3>
    <qrcode value="<?php echo $msg; ?>" ec="L" style="width: 60mm;"></qrcode>
    <br>
