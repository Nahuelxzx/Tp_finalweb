...
$pdf->AddPage();
$pdf->Ln();
$pdf->Image('enc-boarding.jpg',15,38,180);
//$pdf->SetY(46);
$pdf->SetMargins(22,20,20);
$pdf->Ln(20);
$pdf->TablaColores($header);// habilito tabla sin set Y
$pdf->SetMargins(0,0,0);//limpio set margins    	 		 	   
$pdf->Image('pie-boarding.jpg',15,105,180); // 1 desp izq-der 2 des arriba-abajo 3 tam img
$pdf->Output();
?>